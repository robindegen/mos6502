...
bool QHexEditPrivate::processMoveEvents(QKeyEvent *event)
{
    ...
    if(event->matches(QKeySequence::MoveToNextChar))
        ...
        cursor->moveOffset(-(static_cast<sinteger_t>(cursor->offset() % QHexMetrics::BYTES_PER_LINE)));
        ...
        cursor->moveOffset(-(static_cast<sinteger_t>(this->_metrics->visibleLines() - 1) * QHexMetrics::BYTES_PER_LINE));
